...
\begin{equation}
e_{yc,\max}=0.001\,L_{yc}=0.001\cdot140\ \mathrm{mm}
...
=
\frac{0.070^\circ_{\mathrm{el}}}{360^\circ_{\mathrm{el}}}\cdot140\ \mathrm{mm}
...
\begin{equation}
R=\sigma_{yc}^{2}
=\left(8.08\times10^{-5}\right)^2
=6.53\times10^{-9}\ \mathrm{m^2}.
\end{equation}
