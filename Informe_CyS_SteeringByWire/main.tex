...
Analizando entonces los gráficos de perturbaciones, se observa que el torque autoalineante $T_a$ es la perturbación dominante durante la maniobra, pudiendo alcanzar valores 50 veces mayores que el torque de fricción $T_f$.
...
Como se observa en la tabla \ref{tab:validacion_motor_trapezoidal}, los valores de tensión, corriente, torque y velocidad se mantienen dentro de los límites admisibles. En pruebas realizadas utilizando referencia escalón, el pico de corriente podía alcanzar valores de casi $100 A$, y velocidades de $1200 rpm$; de allí la importancia de usar entradas trapezoidales para hacer la validacion del motor.
