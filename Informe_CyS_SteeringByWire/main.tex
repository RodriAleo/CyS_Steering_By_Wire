...
En la presente sección se somete al modelo matemático a una situación de gran exigencia como es lograr que las ruedas roten hasta su máximo rango de $35^\circ$ a partir de una referencia escalón. En la figura \ref{fig:respuesta_escalon} se muestra la respuesta obtenida para $\delta(t)$, y en la figura \ref{fig:control_escalon} se muestra la señal de control $V_m(t)$ necesaria para lograr dicho seguimiento.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figs/RtaDelta_entradaEscalon.png}
    \caption{Respuesta del ángulo de las ruedas $\delta(t)$ ante una referencia escalón de $35^\circ$}
    \label{fig:fuerza_resultante_lateral}
\end{figure}

Como puede observarse, el sistema logra alcanzar la referencia de $35^\circ$ con un tiempo de establecimiento de $162\mathrm{ms}$ y sin sobrepico, y llega al valor de referencia a los $320\mathrm{ms}$, lo cual representa una velocidad promedio de $110 \, \mathrm{^\circ/s}$


\subsection{Cosas a reordenar bien al final de todo}
